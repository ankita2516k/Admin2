// src/Dashboard_a.jsx  (or src/pages/Dashboard_a.jsx if that’s your path)
...
export default function Dashboard_a() {
  ...
  const filteredActivity = query
    ? activity.filter((a) => a.text.toLowerCase().includes(query))
    : activity;
  ...
  return (
    <div className="app-layout">
      ...
      {/* 👇 This marginLeft pushes everything to the right of the sidebar */}
      <div
        className="main-layout"
        style={{ marginLeft: "260px" }} // adjust to your actual sidebar width if needed
      >
        <Topbar />
